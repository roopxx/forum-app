...
class ReplyTopicTests(ReplyTopicTestCase):
    ...
    def test_form_inputs(self):
        ...
        '''
        # Check for the CSRF token input
        self.assertContains(self.response, '<input type="hidden" name="csrfmiddlewaretoken"', count=1)
        
        # Check for the message textarea
        self.assertContains(self.response, '<textarea name="message"', count=1)
